...
import com.weiiboo.common.constant.StatusCode;
...
public enum ExceptionMsgEnum {
    ...
    PASSWORD_INVALID(StatusCode.PASSWORD_INVALID,"密码错误"),

    SMS_CODE_IS_NULL(StatusCode.SMS_CODE_IS_NULL,"验证码为空"),
    SMS_CODE_INVALID(StatusCode.SMS_CODE_INVALID,"验证码为空"),
    UDI_INVALID(StatusCode.UID_INVALID,"uid无效"),
    SMS_CODE_ERROR(StatusCode.SMS_CODE_ERROR,"验证码错误"),
    PHONE_NUMBER_EXIST(StatusCode.PHONE_NUMBER_EXIST,"手机号已被绑定"),
    PHONE_NUMBER_ALREADY_REGISTER(StatusCode.PHONE_NUMBER_NOT_REGISTER,"手机号已被注册"),
    PHONE_NUMBER_NOT_REGISTER(StatusCode.PHONE_NUMBER_NOT_REGISTER,"手机号未注册"),
    PHONE_NUMBER_IS_NULL(StatusCode.PHONE_NUMBER_IS_NULL,"手机号为空"),
    PHONE_NUMBER_INVALID(StatusCode.PHONE_NUMBER_INVALID,"手机号不合法"),
    ...
    FILE_CANNOT_BE_NULL(StatusCode.FILE_CANNOT_BE_NULL,"文件不能为空"),
