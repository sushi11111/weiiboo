...
public class StatusCode {
    ...
    // 手机号格式错误
    public static final Integer PHONE_NUMBER_INVALID = 10012;
    // 手机号为空
    public static final Integer PHONE_NUMBER_IS_NULL = 10013;
    //短信验证码错误
    public static final Integer SMS_CODE_ERROR = 10020;
    //短信验证码为空
    public static final Integer SMS_CODE_IS_NULL = 10021;
    //短信格式错误
    public static final Integer SMS_CODE_INVALID = 10022;
    //登录类型错误
    ...
    //文件不能为空
    public static final Integer FILE_CANNOT_BE_NULL = 50050;
